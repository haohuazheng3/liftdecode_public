...
export const FINDING: FindingContent = {
  ...
  verdict:
    "After a break of three months or more, the first weeks back feel like a wall because you're rebuilding, not because anything is wrong.",
  summary:
    "You came back after months away, the numbers are nowhere near what you remember, and every session feels like proof that something broke while you were gone. Nothing broke: you're measuring week three of a rebuild against the lifter you were before the break. The danger isn't the lost strength; it's what you do about a problem that doesn't exist.",
  mechanism: [
    "Three months off does real damage, and far less than it feels. Studies that track lifters through detraining find strength falls first and fastest, mostly through the nervous system: the coordination, rate of force and confidence under a bar that made your old weights feel normal fade within weeks. Muscle size follows more slowly and less completely. You walk back in with a body that has kept more of its tissue than its skill, which is why the weights feel wrong before they feel heavy.",
    ...
    "Your stall, by your own answer, is less than eight weeks old, and the comparison you gave us is exactly what a rebuild looks like: lower than before, or up only in small, uneven steps. A stall is a statement about two data points taken under the same conditions. One of yours came from a lifter training continuously; the other from a lifter three weeks into retraining. Those are two different people. There is no diagnosis to make yet, only a rebuild to run properly.",
    "What does go wrong in a restart is self-inflicted. Returning at the old weights and volume produces soreness that costs the next session, joints that were not ready, and a second break inside the first month. Programme and diet changes made in week three, to fix a stall that is really a starting point, mean you never see the rebound that was coming anyway. The fix is patience with structure: a start that respects the break, a progression that matches the curve, and a comparison that is fair.",
  ],
  howItShowsUp: [
    "You described yourself as just getting back into it after three or more months away, and your \"stall\" is under eight weeks old.",
    ...
    "You feel embarrassed by the weights, and a little afraid that the strength you had is gone for good.",
  ],
  fix: [
    {
      title: "Start from where you are, not where you were",
      steps: [
        "Set this week's working weights at 60–70% of your last pre-break working weights on main lifts, 50–60% on isolation work. If it feels insultingly light, you have it right.",
        "Cut volume to about half your old weekly set count, roughly 6–10 hard sets per muscle per week, for the first two weeks. Recovery capacity comes back first, and you build it by not exceeding it.",
        "Keep every set 2–3 reps short of failure for the first two weeks. You will regain strength from those sets without being so sore that Thursday's session becomes Saturday's.",
    ...
    },
    {
      ...
      steps: [
        ...
        "From week 3, add one or two hard sets per muscle per week until you are back at your old volume, around week 6–8. If soreness or joint ache starts stacking, hold volume there for a week.",
  ...
  fourWeekPlan: [
    "Week 1: set working weights at 60–70% of pre-break numbers, cut weekly sets to about half, keep 2–3 reps in reserve on every set, and start a clean log with the old numbers ruled off at the top.",
    ...
    "Week 3: add one or two hard sets per muscle, bring the last set of each main lift to 1–2 reps from failure, and keep adding load; you should be around 75–85% of old numbers.",
  ...
  mistakes: [
    ...
    "Changing programmes in week three because the numbers are below what you remember, and never seeing the rebound that was coming.",
