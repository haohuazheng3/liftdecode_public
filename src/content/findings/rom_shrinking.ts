...
export const FINDING: FindingContent = {
  ...
  verdict:
    "The numbers went up because the reps got shorter, not because the muscle got stronger.",
  summary:
    "Your range of motion gets shorter as the weight goes up. That means some of the weight you added was paid for with distance, not muscle: the bottom of each rep getting shallower, the setup drifting, the last reps getting shorter — the load climbing while the muscle's job got smaller. That trade runs out, and when it does it looks exactly like a stall, except the weight you're stuck at was never fully earned.",
  mechanism: [
    ...
    "Some habits speed the trade up. Trying to beat your last session every time, and taking sets to failure, both reward whatever gets the weight up, and a shorter rep always gets the weight up. Pain does it too: a joint that complains at the bottom teaches you to stop before the bottom, and the range leaves without a decision ever being made.",
    ...
    "None of this means you were lying to yourself. Range creeps out under load because the nervous system is solving one problem — get this weight up — and a shorter rep is the cheapest solution. It happens rep by rep, below the threshold of noticing, which is why most lifters only notice it once it's well advanced. Part of your progress was real and part was borrowed; the stall is the loan coming due.",
  ],
  howItShowsUp: [
    ...
    "You take sets past the point where form holds, or push to beat last session every time, and the rep that 'counts' keeps getting uglier.",
    "The stretched position is where a joint tends to complain, so you've learned to turn around just before it.",
  ],
  fix: [
    {
    ...
    },
    {
      ...
      steps: [
        ...
        "If you've been trying to beat your last session every time, stop for 4 weeks: repeat a weight until every rep meets the standard, and only then add load.",
      ],
    },
    {
  ...
  fourWeekPlan: [
    ...
    "Week 2: run the new weights with a 1-second pause at the bottom of every rep, working sets at 1–2 RIR, no sets to failure. Count only reps that meet the standard.",
  ...
  mistakes: [
    ...
    "Chasing the old weight to prove it was real. It was real for the rep you were doing; the question is whether it's real for the rep you want.",
  ],
  trackNotes: {
    physique:
  ...
  relatedFindings: ["training_around_pain", "failure_every_set", "no_forcing_function"],
};
